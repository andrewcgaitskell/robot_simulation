...
@app.route('/chart_plotly_spheres')
async def chart_plotly_spheres():
    # Sample data for the 3D chart
    data = [
        {'x': 0, 'y': 5, 'z': 0, 'value': 10},
        {'x': 2, 'y': 3, 'z': 1, 'value': 15},
...
@app.route('/chart_threejs_spheres')
async def chart_threejs_spheres():
    # Sample data for the 3D chart
    data = [
        {'x': 0, 'y': 5, 'z': 0, 'value': 10},
        {'x': 2, 'y': 3, 'z': 1, 'value': 15},
    ...
    return await render_template('chart_threejs_spheres.html', data=data)
